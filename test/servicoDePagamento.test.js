...
describe("Testes da funcionalidade de Serviço de Pagamento", () => {
  ...
  it("TC01 - Deve retornar mensagem quando nenhum pagamento foi realizado e usuário tenta consultar o último pagamento", () => {
    assert.equal(
      ...
      "Ainda não há pagamentos realizados.",
    );
  });

  const dadosPagamento = [
    {
      codigoDeBarra: "0987-7656-3475",
      empresa: "BC Hydro",
      valorPagamento: 100.0,
    },
    {
      codigoDeBarra: "0123-4567-8901",
      empresa: "Telus",
      valorPagamento: 99.99,
    },
    {
      codigoDeBarra: "9876-5432-1098",
      empresa: "Sanepar",
      valorPagamento: 0.01,
    },
  ];
  ...
  it("TC03 - Deve realizar pagamento corretamente e setar categoria como caro quando dados do pagamento informado são válidos e valor é igual a 100.01", () => {
    const dadosPagamento = {
      codigoDeBarra: "0917-7654-3420",
      empresa: "Copel",
      valorPagamento: 100.01,
    };
    servicoDePagamento.pagar(
      dadosPagamento.codigoDeBarra,
      dadosPagamento.empresa,
      dadosPagamento.valorPagamento,
    );
  ...
  it("TC04 - Deve apresentar mensagem quando código de barras informado já estiver pago", () => {
    const dadosPagamento = {
      codigoDeBarra: "0917-7654-3333",
      empresa: "Best buy",
      valorPagamento: 200.0,
    };
    servicoDePagamento.pagar(
      dadosPagamento.codigoDeBarra,
      dadosPagamento.empresa,
  ...
  const cenariosDadosFaltantes = [
    {
      codigoDeBarra: "",
      empresa: "Telus",
      valorPagamento: 180.54,
      faltante: "Código de Barras",
    },
    {
      codigoDeBarra: "9876-5432-1098",
      empresa: "",
      valorPagamento: 66.71,
      faltante: "Empresa",
    },
    {
      codigoDeBarra: "9876-5432-1098",
  ...
  cenariosDadosFaltantes.forEach(
    ({ codigoDeBarra, empresa, valorPagamento, faltante }) => {
  ...
  const cenariosDadosTipoInvalido = [
    {
      codigoDeBarra: 1234567890,
      empresa: "Apple",
      valorPagamento: 2080.21,
      invalido: "Código de Barras",
    },
    {
      codigoDeBarra: "3476-1232-2158",
      empresa: 9876543210,
      valorPagamento: 325.8,
      invalido: "Empresa",
    },
    {
      codigoDeBarra: "9116-5778-1365",
      empresa: "H&M",
      valorPagamento: "123.20d",
      invalido: "Valor",
    },
  ];

  cenariosDadosTipoInvalido.forEach(
    ({ codigoDeBarra, empresa, valorPagamento, invalido }) => {
  ...
  it("TC09 - Deve retornar último pagamento realizado corretamente quando consulta de último pagamento é realizada", () => {
    ...
    servicoDePagamento.pagar("3333-3333-3333", "Sanepar", 44.2);
